	...
	public function action_create($id = null)
	{
		if (Input::method() == 'POST')
		{
			...
			Upload::register('after', function (&$file) {
				    ...
				    $last_line = system('D:\\wamp\\www\\fagprojekt-wdv\\fagprojekt\\release\\DataParser.exe --file='.$file['saved_to'].$file['saved_as'].' --type='.$file['extension'].' --fileid='.$file->id.'', $retval);
					if($retval < 2) {
					$result = DB::query("
