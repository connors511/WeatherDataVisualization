...
As the size of\todo[fancyline,color=green]{Explicit mention its storage size?} \textsf{bigint} is only twice as big as \textsf{int}, the increase of maximum size of each row is not remarkable.