...
Openstreetmap wasn't that difficult to work with, due to the very well documentations from leaflet\footnote{Documentations for openstreetmap - \url{http://leaflet.cloudmade.com}}.
