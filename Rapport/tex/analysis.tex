...
Openstreetmap wasn't that difficult to work with, due to the documentations from leaflet\footnote{Documentations for openstreetmap - \url{http://leaflet.cloudmade.com}}\todo[color=red,fancyline]{move to references list?}.
