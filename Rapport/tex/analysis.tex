...
Openstreetmap wasn't that difficult to work with, due to the well documentation from leaflet\footnote{Documentations for openstreetmap - \url{http://leaflet.cloudmade.com}}.
