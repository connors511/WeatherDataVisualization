...
There are several ways to locate positions on a map. We have used \emph{conjugate graticule}\footnote{Latitude/Longitude also known as conjugate graticule}, because the test data we had available used this. We haven't implemented for other GPS\footnote{Global Positioning System - see \cite{GPS}} coordinates than latitude and longitude, because of the time pressure.
